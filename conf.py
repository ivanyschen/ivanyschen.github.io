...
BLOG_AUTHOR = "Ivan Chen"  # (translatable)
BLOG_TITLE = "Simple is Complex"  # (translatable)
...
BLOG_EMAIL = "ivanyschen@berkeley.edu"
BLOG_DESCRIPTION = "Hello!"  # (translatable)
...
GLOBAL_CONTEXT = {
        # 'TWITTER_URL': 'https://tddwitter.com/getnikola',
        # 'INSTAGRAM_URL': 'https://github.com/getnikola',
        # 'LINKEDIN_URL': None,
...
EXTRA_FILES_FOR_GITHUB_DEPLOY = ['output/staticman.yml']
